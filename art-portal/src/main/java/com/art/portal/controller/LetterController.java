...
public class LetterController {
	...
	@ResponseBody()
	public String getUserLetterListByPage(String UtoP, String page, String rows, String email, String up)
			throws UnsupportedEncodingException {
		System.out.println("getLetterList" + up);
		EUDataGridResult ullist = letterService.getLetterListByPage(UtoP, Integer.parseInt(page),
				Integer.parseInt(rows), email, up);
	...
	@ResponseBody()
	public String saveUserLetter(String title, String desc, String uemail, String utop, String pemail)
			throws UnsupportedEncodingException {
