...
<body>
			...
			<div class="topctent clearfix">
				...
				<div class="right clearfix fr">
					...
					<div class="shopcar-btn clearfix fl">
						<a href="shopping.html" class="box-s"> 购物车（0） </a>
					</div>
		...
		<div class="wrapper pt40 pb40 clearfix">
			<div class="fl slide-nav white-box">
				<ul>
					...
					<li><a href="wdjm " class="db fs16">我的寄卖</a></li>
					...
					<li><a href="znx" class="db fs16">站内信</a></li>
				</ul>
			</div>
	...
	<div class="footer clearfix">
		...
		<div class="banquan clearfix ta-center">Copyright © 2003-2015
			椿龄文化(chunlingwenhua). All Rights Reserved.</div>
	</div>
	<!--footer end-->
