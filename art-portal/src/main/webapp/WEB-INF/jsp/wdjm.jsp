...
<html>
	...
	<body>
		...
		$.getMySellListByPage=function(e)
		{  var page=1;
			...
			$.ajax(
				{url:"getMySellListByPage",
				 ...
				 for(var i=0;i<jsondata.pageinfo.list.length;i++)
					 {
					 $("#p"+i).html('</span>寄卖号：'+jsondata.pageinfo.list[i].id+'　　 寄卖时间：'+jsondata.time[i]);
					 $("#img"+i).attr("src",jsondata.pageinfo.list[i].imgAddress);
					 $("#title"+i).html(jsondata.pageinfo.list[i].title);
					 $("#unitprice"+i).html(jsondata.pageinfo.list[i].price);
					if(jsondata.pageinfo.list[i].status==1)
						{
						$("#state"+i).html("售卖中");
						}
					else
					...
					// $("#state"+i).html(jsondata.pageinfo.list[i].status);
				...
				<div class="fr slide-show white-box">
					...
					<table class="table_1 mt15" id="tb0">
						...
						<tr>
							...
							<td width="24%" rowspan="0" align="center" id="state0">已收货<br>
					...
					<table class="table_1 mt15" id="tb1">
						<tr>
							<th align="left" colspan="7">
								<p class="fs12" id="p1"><span class="fr pr10" id="price1">订单金额：59.80</span>寄卖号：201410110000152029　　　寄卖时间：2014-10-11 13:26:39　</p>
							</th>
						</tr>
						<tr>
							...
							<td width="24%" rowspan="0" align="center" id="state1">已收货<br>
								<a href="#" class="orange">订单详情</a>
							</td>
					...
					<table class="table_1 mt15" id="tb2">
						<tr>
							<th align="left" colspan="7">
								<p class="fs12" id="p2"><span class="fr pr10" id="price2">订单金额：59.80</span>寄卖号：201410110000152029　　　　寄卖时间：2014-10-11 13:26:39</p>
							</th>
						</tr>
						<tr>
							...
							<td width="24%" align="center" id="state2">已收货<br>
								<a href="#" class="orange">订单详情</a>
							</td>
					...
					<table class="table_1 mt15" id="tb3">
						<tr>
							<th align="left" colspan="7">
								<p class="fs12" id="p3"><span class="fr pr10" id="price3">订单金额：59.80</span>寄卖号：201410110000152029　　　　寄卖时间：2014-10-11 13:26:39</p>
							</th>
						</tr>
						<tr>
							...
							<td width="24%" align="center" id="state3">已收货<br>
								<a href="#" class="orange">订单详情</a>
							</td>
					...
					<div class="tab-pages">
		               <p id="pid"></p>
						<a id="prePage" href="#" value="" class="tab-prev tab-btn" onclick="$.getMySellListByPage($(this));">上一页</a>
						<a id="firstPage" href="#" value="" class="page-btn " onclick="$.getMySellListByPage($(this));">第一页</a>
						<a id="lastPage" href="#" value="" class="page-btn" onclick="$.getMySellListByPage($(this));">最后一页</a>
						<a id="nexPage" href="#" value="" class="tab-next tab-btn" onclick="$.getMySellListByPage($(this));">下一页</a>
						<span class="ml10">到第</span>
						<input type="text" name="" id="jid" value=""  size="1"/>
						<span>页</span>
						<input type="submit" name="" id="" value="确定" onclick="$.getMySellListByPage($(this));"/>
					</div>
