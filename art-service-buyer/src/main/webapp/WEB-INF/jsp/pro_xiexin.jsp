...
var pemail ;
	...
	//页面初始化完毕后执行此方法
	$(function(){
		pemail = '<%=request.getParameter("e")%>';
		$("#ema").attr("value",pemail);
		//创建富文本编辑器
				...
				<div class="fr slide-show white-box">
					<div class="dark-tit dark-tittwo clearfix">
						...
						<p class="fr slide-t-nav">
							...
							<a href="pro_xiexin" class="on fs14 radius3">写信</a>
	...
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	       <tr>
	        ...
	        <tr>
	            <td>收件人:</td>
	            <td><input class="easyui-textbox" type="text" name="uemail" data-options="required:true" style="width: 280px;"></input></td>
	        </tr>
	         <tr>
	        <td><input type="hidden" name="pemail" value="" id="ema"/></td>
	        <td><input type="hidden" name="utop" value="0"/></td>
	        </tr>
