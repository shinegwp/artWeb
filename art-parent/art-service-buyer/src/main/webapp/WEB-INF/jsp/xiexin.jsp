...
<script type="text/javascript">
	...
	//页面初始化完毕后执行此方法
	$(function(){
		$("#ema").attr("value",$.cookie('email'));
		 if(getQuery("email")!=null){
			 $("#pemail").textbox("setValue",getQuery("email")); 
		 }
...
return null; 
	...
	function submitForm(){
		...
		$.post("saveLetter",$("#itemAddForm").serialize(), function(data){
				...
				<div class="fr slide-show white-box">
					<div class="dark-tit dark-tittwo clearfix">
						...
						<p class="fr slide-t-nav">
							<a href="pro_znx" class="fs14 radius3">收件</a>
							<a href="xiexin" class="on fs14 radius3">写信</a>
	...
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	       <tr>
	            <td>标题:</td>
	            <td><input class="easyui-textbox" id="title" name="title" data-options="multiline:true,validType:'length[0,150]'" style="height:60px;width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>收件人:</td>
	            <td><input class="easyui-textbox" type="text" name="pemail" data-options="required:true" style="width: 280px;" id="pemail"></input></td>
	        </tr>
	        <tr>
	        <td><input type="hidden" name="uemail" value="" id="ema"/></td>
	        <td><input type="hidden" name="utop" value="1"/></td>
	        </tr>
